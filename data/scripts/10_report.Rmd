...
table2 <- read.delim("02_filtering-evenness_summarytable_TCR.csv", check.names = FALSE)
...
From here, all the results correspond to the TCR chain selected by the user: ``r params$chain``.
...
Overlapping k-mers of length 3 (k = 3) were extracted from the amino acid CDR3 sequences (R. Amoriello et al., 2020) in each TCR repertoire and condensed into a k-mer frequency distribution. Hierarchical clustering was performed based on euclidean distance for correlations and heatmaps were generated for visualization.
