...
<!-- # 1 - MiXCR quality control {.tabset} -->

<!-- ## Alignment report -->
<!-- ```{r plot1,include= TRUE,  echo = F, message= F, fig.cap= "Figure caption."} -->
<!-- table1 = read.delim(file.path("01_alignment_reports.tsv")) -->
<!-- table1 = table1[,1:3] -->
...
<!-- knitr::include_graphics(path = path.expand(file.path( "01_alignment_report.png"))) -->
<!-- ``` -->

<!-- ## Assemble report -->
<!-- ```{r plot1-3,include= TRUE,  echo = F, message= F, fig.cap= "Figure caption."} -->
<!-- table2 = read.delim(file.path("01_assemble_reports.tsv")) -->
<!-- table2 = table1[,1:3] -->
<!-- # percentage = round(table1$Successfully.aligned.reads/table1$Total.sequencing.reads*100, 3) -->
...
<!-- knitr::include_graphics(path = path.expand(file.path("01_assemble_report.png"))) -->
<!-- ``` -->
...
<!-- table2 = read.delim(file.path(params$inputDir, "02_filtering-evenness_summarytable_TCR.csv")) -->
...
<!-- table2 = read.delim(file.path(params$inputDir, "02_filtering-evenness_summarytable_TRA.csv")) -->
<!-- table2$shannon = round(table2$shannon, 3) -->
...
<!-- table2 = read.delim(file.path(params$inputDir, "02_filtering-evenness_summarytable_TRB.csv")) -->
<!-- table2$shannon = round(table2$shannon, 3) -->
...
<!-- knitr::include_graphics(path = path.expand(file.path(params$inputDir, "03_boxplot_merged.png"))) -->
<!-- ``` -->
...
<!-- knitr::include_graphics(path = path.expand(file.path(params$inputDir, "03_boxplot_ncell.png"))) -->
<!-- ``` -->
...
<!-- knitr::include_graphics(path = path.expand(file.path(params$inputDir, "03_boxplot_rnaquant.png"))) -->
<!-- ``` -->
...
<!-- knitr::include_graphics(path = path.expand(file.path(params$inputDir, "03_boxplot_clones.png"))) -->
<!-- ``` -->
...
<!-- knitr::include_graphics(path = path.expand(file.path(params$inputDir, "03_boxplot_reads.png"))) -->
<!-- ``` -->
...
<!-- knitr::include_graphics(path = path.expand(file.path(params$inputDir,"03_boxplot_shannon.png"))) -->
<!-- ``` -->
...
<!-- knitr::include_graphics(path = path.expand(file.path(params$inputDir, "04_correlations_TRB.png"))) -->
<!-- ``` -->


<!-- # Diversity (clonal expansion) -->
<!-- ```{r plot5,include= TRUE,  echo = F, message= F, fig.cap= "Figure caption."} -->
<!-- knitr::include_graphics(path = path.expand(file.path(params$inputDir, "05_ClonalExpansion.png"))) -->
<!-- ``` -->
...
<!-- knitr::include_graphics(path = path.expand(file.path(params$inputDir, "06_overlap_jaccard.png"))) -->
<!-- ``` -->


<!-- # K-mers (repertoire similarity) -->
<!-- ```{r plot7,include= TRUE,  echo = F, out.width= "70%", out.height="50%", message= F} -->
<!-- knitr::include_graphics(path = path.expand(file.path(params$inputDir, "07_kmers_pearson.png"))) -->
<!-- ``` -->
...
<!-- knitr::include_graphics(path = path.expand(file.path(params$inputDir, "08_network_degree_heatmap.png"))) -->
<!-- ``` -->
...
<!-- table1 = read.csv(file.path(params$inputDir, "09_ddbb_Fisher_mcpasTRB.csv")) -->
<!-- knitr::kable(table1) -->
<!-- ``` -->

<!-- ## VDJdb -->
<!-- ```{r plot9-2,include= TRUE,  echo = F, message= F} -->
<!-- table2 = read.csv(file.path(params$inputDir, "09_ddbb_Fisher_vdjdbTRB.csv")) -->
<!-- knitr::kable(table2) -->
<!-- ``` -->
