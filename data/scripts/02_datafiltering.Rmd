...
save(clones_TCR_filtered, file = file.path(params$workDir,
...
save(clones_TRA_filtered, file = file.path(params$workDir,
...
save(clones_TRB_filtered, file = file.path(params$workDir,
