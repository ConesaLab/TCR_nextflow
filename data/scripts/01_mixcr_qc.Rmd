...
df_gather_chains <- tidyr::gather(data = df_matrix[,c("sampleID","TRA chains","TRB chains",
                                                      "TRD chains","TRG chains","IGH chains",
                                                      "IGK chains", "IGL chains")],
...
df_matrix_assemble[,"sampleID"] <- rownames(df_matrix_assemble)
...
df_gather_chains <- tidyr::gather(data = df_matrix_assemble[,c("sampleID","TRA chains","TRB chains",
                                                      "TRD chains","TRG chains","IGH chains",
                                                      "IGK chains", "IGL chains")],
                                  key = "parameter", value = "reads", -1)
df_gather_chains$parameter <- factor(df_gather_chains$parameter,
