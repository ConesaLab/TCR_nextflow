...
# Article Figures
```{r Supplementary_Figure1B.png, results='show', message=FALSE, warning=FALSE, fig.height=30, fig.width=30, fig.path=file.path(params$workDir, params$articleDir,""), dev=c('png','pdf'), dpi=300}
