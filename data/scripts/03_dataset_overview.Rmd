...
```{r, results='hide'}
# TCR plot
save(p1_shannon_filtered_TCR, file = file.path(params$workDir, "03_boxplot5_shannon_TCR.Rda"))
png(file.path(params$outputDir, "03_boxplot5_shannon_TCR.png"), height = 30, width = 30, units = "cm", res = 300)
p1_shannon_filtered_TCR
dev.off()

# TRA plot
save(p1_shannon_filtered_TRA, file = file.path(params$workDir, "03_boxplot5_shannon_TRA.Rda"))
png(file.path(params$outputDir, "03_boxplot5_shannon_TRA.png"), height = 30, width = 30, units = "cm", res = 300)
p1_shannon_filtered_TRA
dev.off()

# TRB plot
save(p1_shannon_filtered_TRB, file = file.path(params$workDir, "03_boxplot5_shannon_TRB.Rda"))
png(file.path(params$outputDir, "03_boxplot5_shannon_TRB.png"), height = 30, width = 30, units = "cm", res = 300)
p1_shannon_filtered_TRB
dev.off()
```
