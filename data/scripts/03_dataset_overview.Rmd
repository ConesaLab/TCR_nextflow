...
```{r, results='hide'}
# TCR plot
save(p1_readsTCR, file = file.path(params$workDir, "03_boxplot3_readsTCR.Rda"))
png(file.path(params$outputDir, "03_boxplot3_readsTCR.png"), height = 30, width = 30, units = "cm", res = 300)
p1_readsTCR
dev.off()

# TRA plot
save(p1_readsTRA, file = file.path(params$workDir, "03_boxplot3_readsTRA.Rda"))
png(file.path(params$outputDir, "03_boxplot3_readsTRA.png"), height = 30, width = 30, units = "cm", res = 300)
p1_readsTRA
dev.off()

# TRB plot
save(p1_readsTRB, file = file.path(params$workDir, "03_boxplot3_readsTRB.Rda"))
png(file.path(params$outputDir, "03_boxplot3_readsTRB.png"), height = 30, width = 30, units = "cm", res = 300)
p1_readsTRB
dev.off()
```
...
```{r, results='hide'}
# TCR plot
save(p1_clones_filtered_TCR, file = file.path(params$workDir, "03_boxplot4_clonesTCR.Rda"))
png(file.path(params$outputDir, "03_boxplot4_clonesTCR.png"), height = 30, width = 30, units = "cm", res = 300)
p1_clones_filtered_TCR
dev.off()

# TRA plot
save(p1_clones_filtered_TRA, file = file.path(params$workDir, "03_boxplot4_clonesTRA.Rda"))
png(file.path(params$outputDir, "03_boxplot4_clonesTRA.png"), height = 30, width = 30, units = "cm", res = 300)
p1_clones_filtered_TRA
dev.off()

# TRB plot
save(p1_clones_filtered_TRB, file = file.path(params$workDir, "03_boxplot4_clonesTRB.Rda"))
png(file.path(params$outputDir, "03_boxplot4_clonesTRB.png"), height = 30, width = 30, units = "cm", res = 300)
p1_clones_filtered_TRB
dev.off()
```
...
```{r, results='hide'}
# TCR plot
save(p1_shannon_filtered_TCR, file = file.path(params$workDir, "03_boxplot5_shannonTCR.Rda"))
png(file.path(params$outputDir, "03_boxplot5_shannonTCR.png"), height = 30, width = 30, units = "cm", res = 300)
p1_shannon_filtered_TCR
dev.off()

# TRA plot
save(p1_shannon_filtered_TRA, file = file.path(params$workDir, "03_boxplot5_shannonTRA.Rda"))
png(file.path(params$outputDir, "03_boxplot5_shannonTRA.png"), height = 30, width = 30, units = "cm", res = 300)
p1_shannon_filtered_TRA
dev.off()

# TRB plot
save(p1_shannon_filtered_TRB, file = file.path(params$workDir, "03_boxplot5_shannonTRB.Rda"))
png(file.path(params$outputDir, "03_boxplot5_shannonTRB.png"), height = 30, width = 30, units = "cm", res = 300)
p1_shannon_filtered_TRB
dev.off()
```
...
* TCRshannon: Shannon eveness of TCR clones (TRA+TRB+TRD+TRG)
* TRAshannon: Shannon eveness of TRA clones
* TRBshannon: Shannon eveness of TRB clones
```{r}
